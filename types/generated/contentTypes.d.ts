...
export interface ApiAboutUsAboutUs extends Schema.SingleType {
  ...
  attributes: {
    ...
    goal: Attribute.Text;
    chairman_name: Attribute.String;
    chairman_msg: Attribute.RichText;
    chairman_img_url: Attribute.Media;
...
export interface ApiDocumentDocument extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::document.document', 'name'>;
...
export interface ApiImportantLinkBlockImportantLinkBlock
  extends Schema.CollectionType {
  collectionName: 'important_link_blocks';
  info: {
    singularName: 'important-link-block';
    pluralName: 'important-link-blocks';
    displayName: 'ImportantLinkBlock';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ImportantLinkBlock: Attribute.Component<'elements.important-link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::important-link-block.important-link-block',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSubscribeBannerSubscribeBanner extends Schema.SingleType {
  collectionName: 'subscribe_banners';
  info: {
    singularName: 'subscribe-banner';
    pluralName: 'subscribe-banners';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::subscribe-banner.subscribe-banner',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  attributes: {
    ...
    img_url: Attribute.Media;
    role: Attribute.Component<'elements.duty-and-role', true>;
    name: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
